# Release data-flow inventory — source candidate 1.0 (1)
...
| Optional support transaction | StoreKit; feature flag off in 1.0 | Transaction state only when activated | Apple StoreKit | Apple policy | Apple |
