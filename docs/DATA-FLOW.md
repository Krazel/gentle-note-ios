# Release data-flow inventory — source candidate 0.7 (1)
...
| Optional support transaction | StoreKit; feature flag off in 0.7 | Transaction state only when activated | Apple StoreKit | Apple policy | Apple |
