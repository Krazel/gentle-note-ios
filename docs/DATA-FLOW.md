# Release data-flow inventory — source candidate 0.7.2 (1)
...
| Optional support transaction | StoreKit; feature flag off in 0.7.2 | Transaction state only when activated | Apple StoreKit | Apple policy | Apple |
