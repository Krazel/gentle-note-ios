# Release data-flow inventory — source candidate 0.6 (1)
...
| Optional support transaction | StoreKit; feature flag off in 0.6 | Transaction state only when activated | Apple StoreKit | Apple policy | Apple |
